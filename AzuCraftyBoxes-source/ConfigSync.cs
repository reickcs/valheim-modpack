// Vendored 2026-09-09 from https://github.com/AzumattDev/AzuCraftyBoxes/blob/master/ConfigSync.cs
// (Azumatt's ServerSync library -- the same server->client config-push
// mechanism AzuCraftyBoxes and ServerCharacters already use, confirmed by
// their own "ConfigSync RPC registered" boot log lines). Unmodified other
// than this header comment; do not edit below, re-vendor instead.
using System;
