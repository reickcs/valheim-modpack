...
namespace AzuCraftyBoxes
{
    ...
    public class AzuCraftyBoxesPlugin : BaseUnityPlugin
    {
        ...
        internal const string ModVersion = "11.0.0";
        ...
        private void Start()
        {
            ...
            // EpicLoot compatibility (AzuCraftyBoxes.Compatibility.EpicLoot) dropped
            // in this vendored copy -- not run in this modpack (see modpack.yaml),
            // and it was the one known-benign exception source in the old deploy
            // (EpicLoot_UnityLib.InventoryManagement TypeLoadException).
        }
