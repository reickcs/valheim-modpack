...
public class MiscFunctions
{
    ...
    {
        // WardIsLove compatibility branch dropped in this vendored copy (not run
        // in this modpack, see modpack.yaml) -- always uses vanilla PrivateArea,
        // same as upstream's own non-WardIsLove fallback path.
        long playerId = Game.instance.GetPlayerProfile().GetPlayerID();
        return container.CheckAccess(playerId) && PrivateArea.CheckAccess(container.transform.position, flash: false, wardCheck: true);
    }
