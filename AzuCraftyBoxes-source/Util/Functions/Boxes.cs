...
public class Boxes
{
    ...
    // Upstream also scans kg/mkz ItemDrawers, Backpacks, and GemBags (Jewelcrafting)
    // containers here -- dropped in this vendored copy, none of those mods run in
    // this modpack (see modpack.yaml). Vanilla container scan only.
